...
const CbsAddOrTransferClientsToRooms: React.FC = () => {
    ...
    const WhichRoomWillClientGoTo = async (clientID: number, clientFullName: string, clientProgram: string, clientLevelOneCurrentTotal: number) => {
