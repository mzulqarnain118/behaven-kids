...
const ManuallyAddTimeoutModal: React.FC<ManuallyAddTimeoutModal> = ({ showModel, setShowModel, roomInfo, clientID, clientFullName, clientProgram, previousRoomID, staffFullName, staffID, locationID, levelOneTotal, setLevelOneTotal }) => {
    if (!open) return null;
                            ...
                            <div style={{ display: "flex", flexDirection: "row", justifyContent: "center" }}>
                                <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", marginTop: "25px" }}>
                                    ...
                                    <div style={{ display: "flex", flexDirection: "row" }}>
                                        ...
                                        <h4 style={{ marginTop: "15px", marginLeft: "10px" }}>Manual</h4>
                                    </div>
