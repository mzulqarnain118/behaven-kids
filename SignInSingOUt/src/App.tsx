...
import SdpAttendanceStatusOverview from './Pages/SdpAttendanceStatusOverview'
...
const App: React.FC = () => {
  return (
    <>
      ...
      <Route path='/SdpAttendanceStatusOverview' element={<SdpAttendanceStatusOverview/>}></Route>
      </Routes>
    </>
  )
}
